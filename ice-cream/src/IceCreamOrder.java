...
public class IceCreamOrder {
	...
	public IceCreamOrder() {
		...
		if(flavor.length() != 14) {
			...
			if("Cup".equals(vessel) && "Single Scoop".equals(amount))
				unitPrice = 29.99;
			else if("Cup".equals(vessel) && "Double Scoop".equals(amount))
				unitPrice = 49.99;
                        else if ("Cup".equals(vessel) && "Triple Scoop".equals(amount))
				unitPrice = 69.99;

			else if("Cone".equals(vessel) && "Single Scoop".equals(amount))
				unitPrice = 39.49;	
			else if("Cone".equals(vessel) && "Double Scoop".equals(amount))
				unitPrice = 59.49;
			else if("Cone".equals(vessel) && "Triple Scoop".equals(amount))
				unitPrice = 79.49;

			else if("Sundae".equals(vessel) && "Single Scoop".equals(amount))
				unitPrice = 49.99;	
			else if("Sundae".equals(vessel) && "Double Scoop".equals(amount))
				unitPrice = 69.99;
			else if("Sundae".equals(vessel) && "Triple Scoop".equals(amount))
				unitPrice = 89.25;
		}
